...
namespace Практика_Задание__1
{
    ...
    public class Program
    {
        ...
        {                            // Получает координаты
            long x1 = long.Parse(coords[0]), x2 = long.Parse(coords[2]), x3 = long.Parse(coords[4]), x4 = long.Parse(coords[6]),                    // Координаты х и у
                y1 = long.Parse(coords[1]), y2 = long.Parse(coords[3]), y3 = long.Parse(coords[5]), y4 = long.Parse(coords[7]);
            ...
            else Console.WriteLine("No");                                                                                                       // Или "No" - в противном случае
